    ...
    return (
        <div className="grid justify-center gap-6 mt-10 sm:mt-12 md:mt-16 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
            {genresRanking.map((data, i) => (
                <Link href={`https://google.com/search?q=${data.genre}%20genre`} target="_blank" rel="noreferer">
                    <div key={i} className="card bg-primary z-0 w-96 h-96 shadow-xl image-full">
